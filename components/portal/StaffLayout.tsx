            ...
            {open && (
              <div className="absolute right-0 z-20 mt-2 w-72 rounded-xl border border-border bg-card p-2 shadow-lg">
                ...
                <div className="py-1">
                  ...
                  <Link to="/staff/doctors" className="flex w-full items-center gap-3 rounded-lg px-3 py-2 text-sm text-muted-foreground hover:bg-muted hover:text-foreground" onClick={() => setOpen(false)}>
                    <Stethoscope className="h-4 w-4" /> Manage Doctors
                  </Link>
                  <Link to="/staff/staff" className="flex w-full items-center gap-3 rounded-lg px-3 py-2 text-sm text-muted-foreground hover:bg-muted hover:text-foreground" onClick={() => setOpen(false)}>
